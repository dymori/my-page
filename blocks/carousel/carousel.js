...
function bindEvents(block) {
  ...
  slideController.addEventListener('click', () => {
    if (autoPlay) {
...
export default async function decorate(block) {
  ...
  if (!isSingleSlide) {
    ...
    slideIndicatorsNav.classList.add('carousel-indicator-navigation');
    slideIndicatorsNav.setAttribute('aria-label', placeholders.carouselSlideControls || 'Carousel Slide Controls');
    slideIndicators = document.createElement('ol');
    slideIndicators.classList.add('carousel-slide-indicators');
    slideController = document.createElement('div');
    slideController.classList.add('carousel-slide-controller');
    slideController.innerHTML = `
      <button type="button" class="controller" aria-label="${placeholders.stopSlides || 'Stop Slides'}"></button>
    `;
    slideIndicatorsNav.append(slideIndicators);
    slideIndicatorsNav.append(slideController);
